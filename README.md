...
- New Layout Options
- New Color Option (BackgroundColor)
- New Views (Square Wall, Landscape Wall, List, Poster Row, Episodes)
...
- New Game UI
- Fix Widgets
- Added GameControllers
- Added Games Settings
- Added Localized Text
- Added Autocompletion Support
- Added Amazon App
- Added Labels to Widgets
- Updated Layouts (Game, Netflix, TV)
- Updated Dark Mode
- Replaced Wallpapers
- Replaced Now Playing Video (In Background)
- Remove Some Fonts
- Remove Scripts
- Remove Android Oreo Layout
- Remove Vertical Layout [First ever idea]
